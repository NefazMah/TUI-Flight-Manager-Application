...
using TUIAssessmentProject.Models;

namespace TUIAssessmentProject.Controllers
{
    public class AirportsController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,AirportName,CityName,Longitude,Latitude")] Airport airport)
        {
            if (ModelState.IsValid)
            {
